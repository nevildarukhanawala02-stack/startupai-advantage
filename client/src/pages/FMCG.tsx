    ...
    <div className="min-h-screen flex flex-col">
      ...
      >
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://private-us-east-1.manuscdn.com/user_upload_by_module/session_file/310419663029826184/tStgMKEBHmAuGORt.png?Expires=1802557732&Signature=Pk7W-d10RckFSTuFpOqcCGhtc0Ea37e-V~dcrECxYUTet3FOLT7-bubMD3nxr-cHnThAPKa0RUQ8IK2onxv~5iq5smMCtnzM92oZLytgAd-lop5-d45WqDIMtIltm3jbL-Q-l8tEA60LJGa4MJ9QZD9klufGkSChcZ8ypo90IAODoNcRFKiBXSBdVFk0PVUQbVbMCTcSvC7pGLpgxi1moJFqUQ0NxHPWUg~8FUiswcuIRkqjqoNQbYzMvwmCw6hGnVGgFl8aG8Evw66oX1KTLErUg1VwRwiJTAoO-sbJM355wS7PNRbYgHzGSkCkHllZV06NJd0ACLxftzF8tqGcqA__&Key-Pair-Id=K2HSFNDJXOU9YS')`,
        ...
        <div className="container relative z-10 py-20">
            <div className="max-w-3xl">
              ...
              <h1 className="mb-6 text-white">FMCG & Consumer Brands Intelligence</h1>
              <p className="text-xl text-white mb-8 leading-relaxed">
                Understand consumer behavior, optimize distribution, and accelerate market growth with AI intelligence built for FMCG and consumer brands.
              </p>
        ...
        <div className="container">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-white mb-4">FMCG Challenges We Solve</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="bg-gray-800/50 border-gray-700 hover:border-secondary/50 transition-all duration-300 p-8">
                ...
                <p className="text-white mb-4">
                  Identify hidden costs, optimize material usage, and reduce waste across your entire manufacturing operation.
                </p>
                <ul className="space-y-2 text-white text-sm">
