    ...
    <div className="min-h-screen flex flex-col">
      ...
      >
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://private-us-east-1.manuscdn.com/user_upload_by_module/session_file/310419663029826184/RqqkVvbjdRIDNfYL.png?Expires=1802557732&Signature=mjTuXViEYCjxUBq~YO77GcrbIoCwu~bcFqVROgdn3aSc5o1tvzEpErZIgOrRqbv7I4oxE3Hk3jkhKOpm-NB-2CPAWnDNXwuFO5FtcNUHMvI23M5nFa-pIY2a2AxgyJlMdwYHYratTJEV4thfkuaUK70U8IyPfrn32sZBFeHrTUH5p-5kDV86sMrWdwQfL~oS~fIvfAMDC7WghBtRhfHplk85K5l84yEe9hWw0yS1rQ97XWqskhMydawJnx448AMn~M1WQirBC0Tx50UMadd0pui18fNhFIEI3WuEkBdlNhqjYuuUoH30alGFFa5PeTdhdmR7NaE98Te0vIn8SnTGtg__&Key-Pair-Id=K2HSFNDJXOU9YS')`,
        ...
        <div className="container relative z-10 py-20">
            <div className="max-w-3xl">
              ...
              <h1 className="mb-6 text-white">Manufacturing Intelligence</h1>
              <p className="text-xl text-white mb-8 leading-relaxed">
                Optimize production, streamline supply chains, and unlock operational excellence with AI intelligence built for manufacturing.
              </p>
